...
const struct helptxt helptext[] = {
  ...
  {"    --metalink",
   ...
   CURLHELP_MISC},
  {"    --min-ack-delay",
   "Min delay between acks, in ms.",
   CURLHELP_IMPORTANT | CURLHELP_CURL},
  {"    --max-ack-delay",
   "Max delay between acks, in ms.",
   CURLHELP_IMPORTANT | CURLHELP_CURL},
  {"    --negotiate",
  ...
  {"    --quack-reset",
   "Whether to send quack reset messages.",
   CURLHELP_IMPORTANT | CURLHELP_CURL},
  {"    --quack-style",
   "Style of quack to send and receive.",
   CURLHELP_IMPORTANT | CURLHELP_CURL},
  {"    --quiche-cc <cc_algorithm>",
   "Quiche HTTP/3 congestion control algorithm [reno|cubic|bbr].",
   CURLHELP_IMPORTANT | CURLHELP_CURL},
  {"-Q, --quote <command>",
  ...
  {"-S, --show-error",
   ...
   CURLHELP_CURL},
  {"    --sidecar-mtu",
   "Send packets only if the cwnd > mtu.",
   CURLHELP_IMPORTANT | CURLHELP_CURL},
  {"-s, --silent",
   "Silent mode",
   CURLHELP_IMPORTANT | CURLHELP_VERBOSE},
  ...
  {"    --threshold <num_packets>",
   "Set the threshold on the sidecar quACK.",
   CURLHELP_IMPORTANT | CURLHELP_CURL},
  {"-z, --time-cond <time>",
