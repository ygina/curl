...
#define CURLOPT_PROGRESSDATA CURLOPT_XFERINFODATA
  ...
  */
  ...
  CURLOPT(CURLOPT_SIDECAR_INTERFACE, CURLOPTTYPE_STRINGPOINT, 324),
  CURLOPT(CURLOPT_THRESHOLD, CURLOPTTYPE_LONG, 325),
  CURLOPT(CURLOPT_QUACK_RESET, CURLOPTTYPE_LONG, 326),
  CURLOPT(CURLOPT_SIDECAR_MTU, CURLOPTTYPE_LONG, 327),
