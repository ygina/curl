...
#define CURLOPT_PROGRESSDATA CURLOPT_XFERINFODATA
  ...
  */
  ...
  CURLOPT(CURLOPT_SIDECAR_QUACK_RESET, CURLOPTTYPE_LONG, 324),
  CURLOPT(CURLOPT_SIDECAR_MTU, CURLOPTTYPE_LONG, 325),
  CURLOPT(CURLOPT_QUICHE_MIN_ACK_DELAY, CURLOPTTYPE_LONG, 326),
  CURLOPT(CURLOPT_QUICHE_MAX_ACK_DELAY, CURLOPTTYPE_LONG, 327),
  CURLOPT(CURLOPT_SIDECAR_QUACK_STYLE, CURLOPTTYPE_STRINGPOINT, 328),
