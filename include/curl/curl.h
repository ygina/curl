...
#define CURLOPT_PROGRESSDATA CURLOPT_XFERINFODATA
  ...
  */
  ...
  /* QUICHE OPTIONS */
  CURLOPT(CURLOPT_SIDECAR_THRESHOLD, CURLOPTTYPE_LONG, 323),
  CURLOPT(CURLOPT_SIDECAR_MARK_ACKED, CURLOPTTYPE_LONG, 324),
  CURLOPT(CURLOPT_SIDECAR_MARK_LOST_AND_RETX, CURLOPTTYPE_LONG, 325),
  CURLOPT(CURLOPT_SIDECAR_UPDATE_CWND, CURLOPTTYPE_LONG, 326),
  CURLOPT(CURLOPT_SIDECAR_NEAR_DELAY, CURLOPTTYPE_LONG, 327),
  CURLOPT(CURLOPT_SIDECAR_E2E_DELAY, CURLOPTTYPE_LONG, 328),
  CURLOPT(CURLOPT_SIDECAR_RESET, CURLOPTTYPE_LONG, 329),
  CURLOPT(CURLOPT_SIDECAR_RESET_PORT, CURLOPTTYPE_LONG, 330),
  CURLOPT(CURLOPT_SIDECAR_RESET_THRESHOLD, CURLOPTTYPE_LONG, 331),
  CURLOPT(CURLOPT_SIDECAR_REORDER_THRESHOLD, CURLOPTTYPE_LONG, 332),
  CURLOPT(CURLOPT_SIDECAR_QUACK_STYLE, CURLOPTTYPE_STRINGPOINT, 333),
  CURLOPT(CURLOPT_SIDECAR_MTU, CURLOPTTYPE_LONG, 334),
