...
#define CURLOPT_PROGRESSDATA CURLOPT_XFERINFODATA
  ...
  */
  ...
  /* QUICHE OPTIONS */
  CURLOPT(CURLOPT_SIDEKICK_THRESHOLD, CURLOPTTYPE_LONG, 323),
  CURLOPT(CURLOPT_SIDEKICK_MARK_ACKED, CURLOPTTYPE_LONG, 324),
  CURLOPT(CURLOPT_SIDEKICK_MARK_LOST_AND_RETX, CURLOPTTYPE_LONG, 325),
  CURLOPT(CURLOPT_SIDEKICK_UPDATE_CWND, CURLOPTTYPE_LONG, 326),
  CURLOPT(CURLOPT_SIDEKICK_NEAR_DELAY, CURLOPTTYPE_LONG, 327),
  CURLOPT(CURLOPT_SIDEKICK_E2E_DELAY, CURLOPTTYPE_LONG, 328),
  CURLOPT(CURLOPT_SIDEKICK_RESET, CURLOPTTYPE_LONG, 329),
  CURLOPT(CURLOPT_SIDEKICK_RESET_PORT, CURLOPTTYPE_LONG, 330),
  CURLOPT(CURLOPT_SIDEKICK_RESET_THRESHOLD, CURLOPTTYPE_LONG, 331),
  CURLOPT(CURLOPT_SIDEKICK_REORDER_THRESHOLD, CURLOPTTYPE_LONG, 332),
  CURLOPT(CURLOPT_SIDEKICK_QUACK_STYLE, CURLOPTTYPE_STRINGPOINT, 333),
  CURLOPT(CURLOPT_SIDEKICK_MTU, CURLOPTTYPE_LONG, 334),
  CURLOPT(CURLOPT_QUICHE_MIN_ACK_DELAY, CURLOPTTYPE_LONG, 335),
  CURLOPT(CURLOPT_QUICHE_MAX_ACK_DELAY, CURLOPTTYPE_LONG, 336),
  CURLOPT(CURLOPT_QUICHE_CONGESTION_CONTROL, CURLOPTTYPE_STRINGPOINT, 337),
...
typedef enum {
  ...
  CURLINFO_QUICHE_CONN      = CURLINFO_PTR    + 63,
  CURLINFO_LASTONE          = 63
} CURLINFO;
